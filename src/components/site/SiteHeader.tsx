  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      ...
      <div className="bg-primary">
        <div className="max-w-7xl mx-auto px-6 py-2 flex justify-end items-center gap-5 text-white text-sm">
          <a href="tel:321-372-9462" className="flex items-center gap-2">
            <svg
